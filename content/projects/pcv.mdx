...
description: A Python-based interactive game that replaces traditional inputs with real-time computer vision, allowing players to use physical cards as controllers.
date: "2025-01-15"
published: true
repository: 
tags:
